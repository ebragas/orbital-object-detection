...
def train_and_evaluate(output_dir, hparams):
    '''Wraps tf.estimator.train_and_evaluate
    '''
    ...
    mnist_classifier = tf.estimator.Estimator(
        ...
        model_dir=cwd
        + "/cnn-estimators/checkpoints/mnist_convnet_model",  # location to save checkpoints
    )
...
def main(unusedargv):
    # TODO: Move this to task.py which manages command-line args
    train_and_evaluate('placeholder', {'place': 'holder'})
